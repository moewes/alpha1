...
sap.ui.define([
	...
	"use strict";
	return BaseController.extend("rcBerufsinfo.controller.ReferentenAnmeldungenView", {
		onInit: function () {
			var oRouter = this.getRouter();
			oRouter.getRoute("referentenAnmeldungen").attachMatched(this._onRouteMatched, this);
		},
		myData: {
			veranstaltungId: "",
		},
		_onRouteMatched: function (oEvent) {
			...
			oView.bindElement({
				path: "/ReferentenVeranstaltungen('" + oArgs.id + "')",
				events: {
